...
//         <h2 className="text-3xl md:text-4xl font-bold text-center text-primary mb-8">About Us</h2>
...
//           <h2 className="text-3xl md:text-4xl font-bold text-center text-primary mb-8">Our Services</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
//             <div className="bg-white rounded-lg shadow-lg p-6 text-center">
//               <h3 className="text-xl font-semibold text-primary mb-4">Property Management</h3>
//               <p className="text-gray-600">
//                 We handle tenant relations, rent collection, inspections, and maintenance for residential and commercial properties.
//               </p>
//             </div>
//             <div className="bg-white rounded-lg shadow-lg p-6 text-center">
//               <h3 className="text-xl font-semibold text-primary mb-4">Construction Projects</h3>
//               <p className="text-gray-600">
//                 From architectural designs to construction supervision, we deliver quality results that meet client expectations.
//               </p>
//             </div>
//             <div className="bg-white rounded-lg shadow-lg p-6 text-center">
//               <h3 className="text-xl font-semibold text-primary mb-4">Legal Advisory</h3>
//               <p className="text-gray-600">
...
//       {/* Properties Preview */}
//       <section id="properties" className="py-16 max-w-7xl mx-auto px-4">
//         <h2 className="text-3xl md:text-4xl font-bold text-center text-primary mb-8">Featured Properties</h2>
//         <input
//           type="text"
